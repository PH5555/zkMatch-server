...
import com.zkrypto.zkMatch.domain.post.application.request.PostApplyCommand;
import com.zkrypto.zkMatch.domain.post.application.response.CorporationPostResponse;
import com.zkrypto.zkMatch.domain.post.application.response.PostResponse;
...
public class PostController {
    ...
    @GetMapping()
    public ApiResponse<List<PostResponse>> getPost(@AuthenticationPrincipal UUID memberId){
    ...
    @PutMapping()
    public void applyPost(@RequestBody PostApplyCommand postApplyCommand) {
